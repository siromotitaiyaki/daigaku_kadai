clear all; close all;
load ionosphere; % Ionosphereデータセットの読み込み
X=X'; % 特徴量行列
...
num=length(cumulative_contribution_rate); % プロット範囲調整
% グラフのプロット
figure;
plot(1:num,cumulative_contribution_rate,'bo-','LineWidth',2,'MarkerSize',8);
grid on;